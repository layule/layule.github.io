  ...
  (function ($) {
        ...
        if (slider.settings.slideWidth === 0 || (slider.settings.slideWidth > wrapWidth && !slider.carousel) || slider.settings.mode === "vertical") {
          ...
          if (wrapWidth > slider.maxThreshold) {
            ...
            newElWidth = Math.floor(
              (wrapWidth + slider.settings.slideMargin) / Math.ceil((wrapWidth + slider.settings.slideMargin) / (newElWidth + slider.settings.slideMargin)) -
    ...
    doesn't fire after a touchstart (this happens on windows phones only) */
      ...
      var resizeWindow = function (e) {
        ...
        if (slider.working) {
          isBrowser() && window.setTimeout(resizeWindow, 10);
        } else {
      ...
      el.goToSlide = function (slideIndex, direction) {
        ...
        if (slider.settings.mode === "fade") {
          ...
          if (!slider.settings.infiniteLoop && slider.carousel && slider.active.last) {
            ...
            // get the last child position
            eq =
              slider.settings.moveSlides === 1 ? slider.settings.maxSlides - getMoveBy() : (getPagerQty() - 1) * getMoveBy() - (slider.children.length - slider.settings.maxSlides);
